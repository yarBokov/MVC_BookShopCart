        ...
        public async Task<IActionResult> AddBook(BookDTO bookToAdd)
        {
            ...
            try
            {
                if (bookToAdd.ImageFile != null)
                {
                    ...
                    List<string> allowedExtensions = new List<string> { ".jpeg", ".jpg", ".png" };
                    string imageName = await _fileService.SaveFile(bookToAdd.ImageFile, allowedExtensions.ToArray());
        ...
        public async Task<IActionResult> UpdateBook(BookDTO bookToUpdate)
        {
            ...
            try
            {
                ...
                if (bookToUpdate.ImageFile != null)
                {
                    ...
                    List<string> allowedExtensions = new List<string> { ".jpeg", ".jpg", ".png" };
                    string imageName = await _fileService.SaveFile(bookToUpdate.ImageFile, allowedExtensions.ToArray());
